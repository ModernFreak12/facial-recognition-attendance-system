...
from app.ui.theme import (
    BG_DARK, BG_CARD, BG_INPUT, PRIMARY, ACCENT_RED, SECONDARY,
...
class StudentLoginScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        desc = Label(
            text="Use your roll number & date of birth",
        ...
        self.roll_input = TextInput(
            hint_text="University Roll Number",
            multiline=False,
            size_hint=(1, 0.1),
        ...
        self._apply_rounded_bg(login_btn, SECONDARY, radius=14)
        ...
        card.add_widget(self.roll_input)
        card.add_widget(self.dob_input)
    ...
    def login(self, instance):
        ...
        response = (
            ...
            .select("*")
            .eq("univ_roll_no", roll)
            .execute()
        )

        if not response.data:
            self.message_label.text = "Student not found."
            return

        student = response.data[0]
        db_dob = student["date_of_birth"].replace("-", "")
